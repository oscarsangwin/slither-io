...
class SlitherGame:
    ...
    def draw_borders(self):
        ...
        pg.draw.rect(screen, RED, (int(pos_x) - self.border_thickness, 0, self.border_thickness, HEIGHT))
        ...
        pg.draw.rect(screen, RED, (0, int(pos_y) - self.border_thickness, WIDTH, self.border_thickness))
        ...
        if length < 0:
            ...
            pg.draw.rect(screen, maroon, (0, 0, int(pos_x)-self.border_thickness, HEIGHT))
        ...
        if length < 0:
            ...
            pg.draw.rect(screen, maroon, (0, 0, WIDTH, int(pos_y)-self.border_thickness))
...
class SlitherMenu:
    ...
    def update(self):
        ...
        if fonts_loaded:
            ...
            if self.last_cooldown and time.time() - self.last_cooldown < self.cooldown_time:
                return
